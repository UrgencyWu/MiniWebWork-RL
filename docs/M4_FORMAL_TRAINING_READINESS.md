...
| 1293 | `b9335f827d1803e485d37c8ecdc704d807e1524e` | runtime v5 clean CPU 包装器首次提交 | 2 CPU / 8 GB / 1 h 上限 | shell 在提交侧提前展开命令替换，pytest 未启动；包装器失败诊断，不是代码失败 |
| 1294 | `b9335f827d1803e485d37c8ecdc704d807e1524e` | runtime v5 clean 非浏览器 CPU 回归 | 2 CPU / 8 GB / 1 h 上限 | `COMPLETED 0:0`；`418 passed, 10 deselected`；PASS |
| 1295 | `b9335f827d1803e485d37c8ecdc704d807e1524e` | runtime v5 32-lane GRPO online E2E | 1 GPU / 8 CPU / 48 GB / 24 h 上限 | `COMPLETED 0:0`，17:48；8 个 K=4 group、8040 tokens、2 次 optimizer update、原子 commit/wake 全部通过；371.55 trajectories/hour，generation P50=11%、显存余量≥36.44%，故正确性 PASS、性能 `NOT_READY` |
| 1296 | `b9335f827d1803e485d37c8ecdc704d807e1524e` | runtime v5 32-lane Step-aware online E2E | 1 GPU / 8 CPU / 48 GB / 24 h 上限 | `FAILED 1:0`，10:31；8 个 K=4 group、8144 tokens；mean/P95/P99/P99.9/clip/mean-ratio 全通过，仅单 token max-log-ratio `2.66791>ln(10)` 在 optimizer 前拒绝；保留为校验设计诊断，不追溯改判 |
| 1297 | pre-commit working tree（基于 `b9335f8`） | runtime v6 定向 parity 回归 | 2 CPU / 8 GB / 24 h 上限 | `FAILED 1:0`；`35 passed, 1 failed`，新增 1000-token 测试夹具未同步 generated-token SHA；生产校验未失败，保留为测试证据诊断 |
