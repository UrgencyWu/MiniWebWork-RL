...
1. [`M5_WEBSHOP_CREDIT_ASSIGNMENT_STUDY.md`](M5_WEBSHOP_CREDIT_ASSIGNMENT_STUDY.md) — current frozen interview-focused study: public WebShop, shared verified SFT, multi-turn GRPO versus public-anchor GiGPO-style credit.
2. [`M5_EXECUTION_READINESS.md`](M5_EXECUTION_READINESS.md) — live fail-closed checklist and Slurm dependency plan; formal training remains closed.
3. [`CURRENT_STATUS.md`](CURRENT_STATUS.md) — current implementation and historical stage evidence.
