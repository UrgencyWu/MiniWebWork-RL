#!/usr/bin/env bash
# Phase10-C: one-update, five-task capability-weighted Raw35 LoRA probe.
#SBATCH --job-name=m6-p10c-q35-sft-probe
...
#SBATCH --mem=96G
#SBATCH --gres=gpu:2
#SBATCH --output=logs/m6_phase10c_q35_sft_probe_%j.out
#SBATCH --error=logs/m6_phase10c_q35_sft_probe_%j.err
