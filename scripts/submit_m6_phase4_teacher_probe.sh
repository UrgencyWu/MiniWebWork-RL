...
teacher_root="$repo_root/outputs/m6_monotonic_posttraining_v1/phase4_rl_data_v1/teacher_probe_qwen35_9b_v1"
...
probe_job="$($slurm_bin/sbatch --parsable --dependency="afterok:$prep_job" \
  --export="ALL,M6_EXPECTED_GIT_SHA=$expected_git_sha,M6_SERVICE_BASE_URL=$M6_SERVICE_BASE_URL" \
